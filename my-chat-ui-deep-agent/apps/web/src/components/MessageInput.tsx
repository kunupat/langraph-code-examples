        ...
        <footer className="border-t border-neutral-800">
            <div className="max-w-2xl mx-auto px-4 py-4">
                <form className="relative" onSubmit={handleSubmit}>
                    <div className="relative bg-neutral-900 rounded-xl border border-neutral-800 focus-within:border-blue-500 transition-colors">
                        <textarea
                            name="content"
                        ...
                        <button
                            type="submit"
                            disabled={disabled}
                            className="absolute right-2 top-1/2 -translate-y-1/2 p-2 rounded-lg bg-blue-500 hover:bg-blue-600 disabled:bg-neutral-700 disabled:cursor-not-allowed text-white disabled:text-neutral-500 transition-colors"
                        >
